...
import {addPromptset, classificationPrompt, excludePrompt, ExcludePromptOpt, getPatternsCategory} from '@sosarciel-stablediffusion/imagedata-prompt-classifier';
